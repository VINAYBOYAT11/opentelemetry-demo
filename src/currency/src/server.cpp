...
namespace
{
  ...
  class CurrencyService final : public oteldemo::CurrencyService::Service
  {
                                  ...
                                  GetSupportedCurrenciesResponse *response) override
    {
      ...
      auto span =
          get_tracer("currency")->StartSpan(span_name, {{"rpc.system", "grpc"}, {"rpc.service", "oteldemo.CurrencyService"}, {"rpc.method", "GetSupportedCurrencies"}, {"rpc.grpc.status_code", 0}}, options);
                   ...
                   Money *response) override
    {
      ...
      auto span =
          get_tracer("currency")->StartSpan(span_name, {{"rpc.system", "grpc"}, {"rpc.service", "oteldemo.CurrencyService"}, {"rpc.method", "Convert"}, {"rpc.grpc.status_code", 0}}, options);
      auto scope = get_tracer("currency")->WithActiveSpan(span);
