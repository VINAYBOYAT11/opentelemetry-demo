...
Build from the repository root so the Dockerfile can copy the frontend and shared protobuf files:
...
The production image serves the Next.js standalone server on `FRONTEND_PORT`.
